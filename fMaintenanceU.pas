...
type
  TfMaintenance = class(TForm)
    ...
    txtGroup1Name: TStaticText;
    txtGroups: TStaticText;
    cbxGroup1: TCheckBox;
    txtGroup2Name: TStaticText;
    cbxGroup2: TCheckBox;
    txtGroup3Name: TStaticText;
    cbxGroup3: TCheckBox;
    lblSurname: TLabel;
    lblFirstname: TLabel;
...
//  Top:= fTop;
//  Left:= fLeft;
  txtGroup1Name.Caption:= dmoMaintenance.GroupName(1);
  txtGroup2Name.Caption:= dmoMaintenance.GroupName(2);
  txtGroup3Name.Caption:= dmoMaintenance.GroupName(3);
  edtSurname.SetFocus;
...
Begin
  ...
  dmoMaintenance.StartCardSearch;
End;
...
Begin
  ...
  Begin
    ...
    Begin
      ...
      Else
        iOrgID:= 0;
      aContact.Group1:= cbxGroup1.Checked;
      aContact.Group2:= cbxGroup2.Checked;
      aContact.Group3:= cbxGroup3.Checked;
...
//  btnAdd.Enabled:= True;
  ...
  Begin
    ...
    cbxGroup1.Checked:= dmoMaintenance.ContactInGroup(aContact.iCardID, 1);
    cbxGroup2.Checked:= dmoMaintenance.ContactInGroup(aContact.iCardID, 2);
    cbxGroup3.Checked:= dmoMaintenance.ContactInGroup(aContact.iCardID, 3);
